...
echo "========================================"
echo ""
echo "Package TAR: $TAR_FILE (Size: $FILE_SIZE_TAR)"
echo "Package ZIP: $ZIP_FILE (Size: $FILE_SIZE_ZIP)"
echo ""
echo "To transfer to server:"
echo "  scp $ZIP_FILE root@66.116.197.150:/root/ || scp $TAR_FILE root@66.116.197.150:/root/"
echo ""
